...
other populations, % what do you mean by parameters? - JJ
...
to find a solution and the number of instances where it found it. % in which aspect? - JJ
% clarified - Mario
...
% not at all - M,  but I all ways fool my self that something after 2000 is new or recent :)
