...
\titlerunning{Event-driven multi-algorithm optimization}
\author{Mario Garc\'ia-Valdez\inst{1}\orcidID{0000-0002-2593-1114} \and
Juan J. Merelo \inst{2}\orcidID{0000-0002-1385-9741}}

\authorrunning{M. Garc\'ia-Valdez \and J. J. Merelo  }

\institute{
  Tijuana Institute of Technology, Tijuana, Baja California, México\\
\email{mario@tectijuana.edu.mx} \and
...
\begin{figure*}[h!tb]
  \centering
\includegraphics[width=4.5in]{../images/kafkeo}
...
%When the \texttt{population\_mixer} unit receives three
...
function, each one having a distinct optimum value. The BBOB testbed % which testbed? % BBOB -M
...
\autoref{tab:params:10} shows the parameters we have used (from \cite{GARCIAVALDEZ2021234:anon}). 
...
\end{figure}
%
Finnally, the PSO\&GA multi-population algorithm, shown in the
...
helpful suggestions and corrections. This work received support from 
projects DeepBio (TIN2017-85727-C4-2-P) and TecNM (11356).
