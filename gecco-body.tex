...
Figure \ref{fig:avg} shows that the number of evaluations of {\sf GA-PSO-m} 
is competitive with PSO in the same framework, although the success 
rate is higher (Figure \ref{fig:bbob}). % Please check that this is true - JJ
% One compares between our own multi-populations the other against the rest -Mario
...
% That is why appears on top. Reaches but takes more evals. 
