...
This better exploitation capability was used by Grimaldi et al. \cite{grimaldi2005genetical}, % But
                                % I don't have the paper and I'll have
                                % to check - JJ
...
We deployed the container-based application in which we run the experiments in a
